...
def generate_custom_password(prefix):
    ...
    return f"{prefix}_SPIDY_{random_part2}"
...
BOT_TOKEN = "8196913174:AAEd5_2KGrBdKIN2Eh2_v6YU2_bBeGn-ZEU"
...
📋 **Available Commands:**
/generate - Create new accounts (Max 100)
...
def handle_account_count(message):
    ...
    try:
        ...
        if 1 <= count <= 30:  # Changed from 20 to 30
            session["count"] = count
...
def show_help(call):
    help_text = """
🤖 **SPIDY Account Generator Bot - Help**

**📋 Available Commands:**
/start - Start the bot
/generate - Create new accounts (Max 30)  
/stats - View statistics
/download - Get account files
...
if __name__ == "__main__":
    print("🚀 Starting SPIDY Telegram Bot...")
